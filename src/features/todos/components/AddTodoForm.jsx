...
export default function AddTodoForm({
  ...
  return (
    <div id="add" className="w-full max-w-3xl flex flex-wrap gap-2 mb-3" aria-busy={isBusy}>
      <input
        className="flex-1 min-w-[120px] p-3 rounded-xl bg-gray-800 border border-gray-700 mb-1"
      ...
      <div id="options" className="w-full max-w-3xl flex flex-wrap gap-2 justify-end">
        <CategoryPopoverButton
          value={category}
